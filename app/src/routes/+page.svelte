    ...
    <div class="resources-cont">
        <div class="title-cont">
            <span class="title">
                <h2>Resources:</h2>
                <p class="sub-title">
                    Here you can find the resources to help you get started with SSP Lab.
                </p>
            </span>
        </div>
        <div class="resources-list">
            <ResourceTile
                name="User Guide"
                texts={["Guide"]}
                links={["https://github.com/AaltoIIC/SSPLab/wiki/User-Guide"]}
                icon={`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor">
            ...
            <ResourceTile
                name="Developer Docs"
                texts={["Docs"]}
                links={["https://github.com/AaltoIIC/SSPLab/wiki/Developer-Docs"]}
                icon={`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="0.4" stroke="currentColor">
            ...
            <ResourceTile
                name="GitHub"
                texts={["GitHub"]}
                links={["https://github.com/AaltoIIC/SSPLab"]}
...
<footer>
    <div class="footer-logo-cont">
        <img class="footer-logo" src="./../icon.svg" alt="SSP Lab Logo">
        <h4>SSP Lab</h4>
    </div>
    <div>
        <b>Docs</b>
